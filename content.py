...
<div class="message-bubble-border" style="display:flex; max-width: 75%; border-radius: 8px; border-width: 1px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); backdrop-filter: blur(10px);">
    ...
    <div style="padding: .5rem 1.5rem;">
        ...
        <p style="text-align: left; font-size: 16px; line-height: 1.5; margin-bottom: 15px;">Welcome to the llama-cpp-agent framework! In this space you can chat with a research agent that can access the web and will provide you with a research report on any topic you ask to it.</p>
